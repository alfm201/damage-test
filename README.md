...
`BD` = 해당 공격 타입의 백어택 대미지
`MD` = 근거리 대미지
`SD` = 상태이상 대미지

`rawMIN` = 해당 공격 타입의 최소 대미지 고정값(+)
`FMIN` = 해당 공격 타입의 최종 최소 대미지
`MIN` = FMIN 적용 후 최소 대미지

`rawMAX` = 해당 공격 타입의 최대 대미지 고정값(+)
`FMAX` = 해당 공격 타입의 최종 최대 대미지
`MAX` = FMAX 적용 후 최대 대미지

`rawCD` = 해당 공격 타입의 크리티컬 대미지 고정값(+)
`FCD` = 해당 공격 타입의 최종 크리티컬 대미지
